...
import { ModalService, ViewModalConfig, DeleteModalConfig } from '../../core/services/modal.service';
...
@Component({
  ...
  template: `
    ...
    <app-delete-confirmation-modal
      ...
      [confirmText]="deleteModalConfig?.confirmText || 'Sí, eliminar'"
      [confirmIcon]="deleteModalConfig?.confirmIcon || 'pi pi-trash'"
      [loadingText]="deleteModalConfig?.loadingText || 'Eliminando...'"
